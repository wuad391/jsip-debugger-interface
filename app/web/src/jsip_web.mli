(** The web interface: Bonsai views over {!Jsip_web_components}'s data,
    plus the canvas heap widget. [app/web/client] is the js_of_ocaml entry
    point that fetches the inputs and starts {!App}. *)
